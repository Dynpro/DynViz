...
// modified by arman khan- final correct code
...
//       const userData = {
//         email: email,
//         role: 'admin', // Default role to 'admin' if not provided
//         id: decodedToken.id,
//         fullName: 'User Full Name', // Placeholder for full name, adjust as needed
//         username: decodedToken.username // Assuming username is part of the token payload
//       }

//       return [200, { accessToken, userData }]
//     } else {
//       error = { email: ['Invalid email or password'] }
//       return [401, { error }]
//     }
//   } catch (err) {
//     return [500, { error: { email: ['Server error'] } }]
//   }
// })
...
//       password,
//       username,
//       fullName: '', // Placeholder, adjust as needed
...
//         // ** Set new token in localStorage
//         window.localStorage.setItem(defaultAuthConfig.storageTokenKeyName, accessToken)
//         const obj = { userData: { email: 'user@example.com', role: 'admin', id: userId } } // Placeholder user data
...
//       // ** return 200 with user data
//       response = [200, { userData: { email: 'user@example.com', role: 'admin', id: userId } }] // Placeholder user data
//     }
//   })
