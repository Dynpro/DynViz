// src/api/connections/createConnection.js
import axios from 'axios'

export const createConnection = async formData => {
  ...
  try {
    const response = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/connection/create`, payload, {
      headers: {
